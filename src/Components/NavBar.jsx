...
function NavBar() {
    ...
    return ( 
        <>
        <div className="flex bg-black h-20 w-100vh sticky top-0 justify-between">
            ...
            <div className="flex Link">
                <ul className={Click ? "Poke" : ""}>
                    <li className="mr-6 hover:text-[pink]"><Link to={"/"}>Home</Link></li>
                    <li className="mr-6 hover:text-[pink]"><Link to={"/Pokedex"}>PokeDex</Link></li>
                    <li className="mr-6 hover:text-[pink]"><Link to={"/Contact"}>Contact Us</Link></li>
                    <li className="mr-6 hover:text-[pink]"><Link to={"/Contact"}>Resume</Link></li>
